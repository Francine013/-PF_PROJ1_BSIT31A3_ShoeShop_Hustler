    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Nike", 65.00m, new DateTime(2024, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Classic Nike Air Max with iconic design", "/images/shoes/airmax90.jpg", true, "Air Max 90", 120.00m },
                    { 2, "Nike", 70.00m, new DateTime(2024, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Legendary basketball shoe", "/images/shoes/airforce1.jpg", true, "Air Force 1", 130.00m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "One Bowerman Drive, Beaverton, OR 97005", "orders@nike.com", "+1-800-NIKE", true, "Nike Distribution Inc." },
                    { 2, "Adi-Dassler-Strasse 1, Herzogenaurach, Germany", "supply@adidas.com", "+49-9132-84-0", true, "Adidas Supply Chain" },
                    { 3, "PUMA Way 1, Herzogenaurach, Germany", "wholesale@puma.com", "+49-9132-81-0", true, "Puma Wholesale Partners" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "White/Red", "#FFFFFF", true, 5, 1, 25 },
                    { 2, "Black/White", "#000000", true, 5, 2, 30 }
                });
